...
class LPL_Data:
    def __init__(self):
        ...
        self.db = pymysql.connect(
            ...
            passwd='Wu521314', db='lpl', charset='utf8')
    ...
    def all_html(self):
        ...
        html_list = [('战队胜率前五', wings_top5_html), ('战队金钱前十二', wings_money12_html),
                     ('个人击杀前五', member_kill_top5),
    ...
    def data(self):
        ...
        # 战队排行榜前五
        wings_top_rule = ["//tbody[@id = 'teamRank']/tr/td[2]/text()", "//tbody[@id = 'teamRank']/tr/td[3]/b/text()",
                          "//tbody[@id = 'teamRank']/tr/td[5]/b/text()"]
        ...
        # 战队胜负数据表
        wings_money12_rule = ["//tbody[@id = 'teamRank']/tr/td[2]/text()",
                              "//tbody[@id = 'teamRank']/tr/td[4]/b/strong/text()",
                              "//tbody[@id = 'teamRank']/tr/td[4]/b/em/text()",
                              "//tbody[@id = 'teamRank']/tr/td[5]/b/text()"]
        ...
        member_kill_sum = [i[:3] for i in
                           html_dict['个人击杀前五'].xpath('//tbody[@id="personalRank"]/tr/td[5]/b/text()')[:5]]
        ...
        member_mvp_top12_kill_sum = [i[:3] for i in
                                     html_dict['个人MVP前十二'].xpath('//tbody[@id="personalRank"]/tr/td[5]/b/text()')]
        member_mvp_top12_assist_sum = [i[:3] for i in html_dict['个人MVP前十二'].xpath(
            '//tbody[@id="personalRank"]/tr/td[6]/b/text()')]
        member_mvp_top12_die_sum = [i[:3] for i in
                                    html_dict['个人MVP前十二'].xpath('//tbody[@id="personalRank"]/tr/td[7]/b/text()')]
        member_mvp_top12 = [member_mvp_top12_name, member_mvp_top12_out_count, member_mvp_top12_kill_sum,
                            member_mvp_top12_assist_sum, member_mvp_top12_die_sum]

        # 英雄pick率前六十
        hero_name = [j for i in html_dict['英雄pick率前六十'] for j in i.xpath('//*[@id="heroRank"]/tr/td[2]/text()')]
        hero_out_count = [j for i in html_dict['英雄pick率前六十'] for j in
                          i.xpath('//*[@id="heroRank"]/tr/td[3]/b/text()')]
        hero_pick = [j for i in html_dict['英雄pick率前六十'] for j in i.xpath('//*[@id="heroRank"]/tr/td[4]/b/text()')]
        hero_win_rete = [j for i in html_dict['英雄pick率前六十'] for j in
                         i.xpath('//*[@id="heroRank"]/tr/td[6]/b/text()')]
